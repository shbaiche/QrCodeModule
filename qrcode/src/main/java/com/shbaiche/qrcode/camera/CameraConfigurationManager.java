 ...
 */
package com.shbaiche.qrcode.camera;
...
final class CameraConfigurationManager {
    ...
    @SuppressWarnings("deprecation")
    @SuppressLint("NewApi")
    private Point getDisplaySize(@NonNull final Display display) {
    ...
    public void setDesiredCameraParameters(@NonNull Camera camera, boolean safeMode) {
        Camera.Parameters parameters = camera.getParameters();
        if (parameters == null) {
     ...
     */
    @NonNull
    private Point findBestPreviewSizeValue(@NonNull Camera.Parameters parameters, @NonNull Point screenResolution) {
